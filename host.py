...
import nacl              #import pynacl
import nacl.public

fPub = open("public.key", "r")
Pub = fPub.read()                                                               #we do this to make a var with type "string" from one with type "file"

serverPublic = nacl.public.PublicKey(Pub, encoder=nacl.encoding.HexEncoder)     #create a public key object, import key encoded in hexidecimal
...
sock.bind(("127.0.0.1",port))                                                   #socket now uses our ip and port
